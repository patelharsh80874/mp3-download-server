...
app.get("/generate-audio", async (req, res) => {
    ...
    try {
        // Temporary paths for audio, image, and output
        const audioPath = path.resolve(tempFolder, "temp_audio.mp4");
        const convertedAudioPath = path.resolve(tempFolder, "temp_audio.mp3");
        const imagePath = path.resolve(tempFolder, "temp_image.webp");
        const convertedImagePath = path.resolve(tempFolder, "temp_image.jpg");
        const outputPath = path.resolve(tempFolder, `${songName}.mp3`);
